...
class NotFoundState extends State<NotFound> with TickerProviderStateMixin,WidgetsBindingObserver{
  String email;
  String password;
...
class TasksNotFoundView extends StatelessWidget {
  const TasksNotFoundView(
      {Key key,
  ...
  final int index;
  final NotFoundState loginState;

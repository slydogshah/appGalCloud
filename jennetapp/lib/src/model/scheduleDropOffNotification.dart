...
class ScheduleDropOffNotification
{
  SourceOrg sourceOrg;
  ...
  ScheduleDropOffNotification(SourceOrg sourceOrg, FoodRunner foodRunner, int start)
  {
  ...
  ScheduleDropOffNotification.fromJson(Map<String, dynamic> json)
  {

...
public class PushNotifications {
    ...
    @Test
    public void firstNotification() throws Exception{
        /*List<String> scopes = new ArrayList<>();
        scopes.add("https://www.googleapis.com/auth/firebase.messaging");
        GoogleCredentials googleCredentials = GoogleCredentials
                .fromStream(new FileInputStream("/Users/babyboy/mamasboy/appgallabs/jen/mumma/appGalCloud/appgal-cloud/service-account.json"))
                .createScoped(scopes);
        googleCredentials.refresh();
        googleCredentials.refreshAccessToken();
